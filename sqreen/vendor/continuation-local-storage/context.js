/**
 * This is a modified version of original CLS package
 */
'use strict';
...
function reset() {
  ...
  if (process.sqreen_namespaces) {
    Object.keys(process.sqreen_namespaces).forEach(function (name) {
      destroy(name);
    });
  }
  process.sqreen_namespaces = Object.create(null);
}
if (!process.sqreen_namespaces) reset(); // call immediately to set up
//$lab:coverage:on$
module.exports = {
  getNamespace     : get,
