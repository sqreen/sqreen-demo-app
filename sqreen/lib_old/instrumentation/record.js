 ...
 */
'use strict';
const ReportUtil = require('../../lib/instrumentation/reportUtil');
const Util = require('../../lib/instrumentation/../util');
const InstruUtils = require('../../lib/instrumentation/./utils');
const Rules = require('../../lib/rules');
const Events = require('../events');
const TYPE = require('../../lib/instrumentation/../enums/events').TYPE;
const SDK_TYPE = require('../../lib/instrumentation/../enums/sdk').TYPE;
const Feature = require('../../lib/command/features');
const FORMAT_VERSION = '20171208';
const Logger = require('../../lib/instrumentation/../logger');
const Fuzzer = require('../../lib/instrumentation/../fuzzer');

const InstruState = require('../../lib/instrumentation/state');
...
const Record = class {
    ...
    reportMetric() {
        ...
        this.observed.observations.forEach((x) => {
            ...
            require('../metric').addObservations([[x.category, x.key, x.value]], x.time);
        });
    }

    report(req, res) {

        this.isLegacyRecord = undefined;
